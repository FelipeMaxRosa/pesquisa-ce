...
namespace SmartDeviceProject1
{
  public class Criptografia
  {
    ...
    private const string cryptoKey = "MAXpcHRvZ3JhZmlhcyBjb20gUmluamRhZWwgLyBBRVM=";
    ...
    public DateTime Decrypt()
    {
      string date = "";
      string pathFile = @"\Micromax\PesquisaCE\licenca.dat";
      StreamReader file = new StreamReader(pathFile);
      string line = file.ReadLine();
      date += line.Substring(7, 1); //d
      date += line.Substring(3, 1); //dd
      date += line.Substring(9, 1); //m
      date += line.Substring(0, 1); //mm
      date += line.Substring(12, 1); //a
      date += line.Substring(5, 1); //aa
      date += line.Substring(20, 1); //aaa
      date += line.Substring(16, 1); ///aaaa
